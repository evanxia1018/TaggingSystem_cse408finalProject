...
public class LDABasedDocumentSimilarityTest {
    ...
    String ldaDataFolder = "data/semilar-data/LDA-tool-test-data";
    ...
    public static void main(String[] args) {
        ...
        String thetaFile = "data/semilar-data/LDA-tool-test-data/ulpc_train_lda_preprocessed.txt.LDA-Test-Model.theta";
